...
run 'rm -rf vendor'
run 'curl -L https://github.com/nachoal/rails-bootstrap-styles/archive/master.zip > stylesheets.zip'
run 'unzip stylesheets.zip -d app/assets && rm stylesheets.zip && mv app/assets/rails-bootstrap-styles-master app/assets/stylesheets'
...
###################################### Git #####################################
git add: '.'
git commit: "-m 'Start rails project with bootstrapped template'"
end
